...
def start_hadoop():
    ...
    '''
    subprocess.run(["wsl", "bash", "-c", "sudo -u hadoop /home/hadoop/hadoop-3.3.6/sbin/stop-dfs.sh"])
    subprocess.run(["wsl", "bash", "-c", "sudo -u hadoop /home/hadoop/hadoop-3.3.6/sbin/stop-yarn.sh"])    
    '''

    #subprocess.run(["wsl", "su", "-", "hadoop", "-c", "/home/hadoop/hadoop-3.3.6/sbin/stop-dfs.sh"])
